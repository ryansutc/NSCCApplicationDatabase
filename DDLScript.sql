...
--  DDL for Table PERSONALINFO
	...
	ENGLISH CHAR(1) DEFAULT 'Y', 
	OTHERCITIZENCOUNTRY CHAR(2), 
	FIRSTLANG VARCHAR2(50), 
	PROGRAM1 INT, 
	PROGRAM2 INT, 
	CAMPUS1 INT, 
	CAMPUS2 INT, 
...
--  Constraints for Table PROGRAMCAMPUSMAPPING
  ...
  ALTER TABLE PROGRAMCAMPUSMAPPING MODIFY ID INT NOT NULL;
...
--  Constraints for Table CITIZENSHIPLU
  ...
  ALTER TABLE CITIZENSHIPLU MODIFY ID INT NOT NULL;
